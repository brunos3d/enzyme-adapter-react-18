...
module.exports = function detectFiberTags() {
  ...
  return {
    ...
    ContextConsumer: supportsContext ? getFiber(React.createElement(Ctx.Consumer, null, () => null)).tag : -1,
    ContextProvider: supportsContext ? getFiber(React.createElement(Ctx.Provider, { value: null }, null)).tag : -1,
    ...
    Profiler: supportsProfiler
      ...
      : -1,
    Suspense: supportsSuspense ? getFiber(React.createElement(React.Suspense, { fallback: false })).tag : -1,
